...
const MonthHeader = (props) => {
  ...
  return (
    <div
      className={`${isOpen ? "border-zinc-400" : "border-transparent"} flex items-center bg-zinc-200 px-6 py-3 rounded-full mb-2 hover:cursor-pointer hover:bg-zinc-300 border transition duration-350`}
      onClick={onClick}>
